                    ...
                    <div class="owl-carousel service-carousel">
                        <div class="service-item">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                ...
                                <a href="" class="border-bottom border-secondary text-decoration-none text-secondary"></a>
                            </div>
                        </div>
                        <div class="service-item">
                            <div class="service-img mx-auto">
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="text-center">
                            ...
                            <h4 class="font-weight-light mb-4">This ice cream shop is more than a business; its a community hub. They host fun events, support local causes, and treat everyone like family. Their mango sorbet is the best I have ever had </h4>
                            <img class="img-fluid mx-auto mb-3"  alt="">
                            </div>
                        <div class="text-center">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <h4 class="font-weight-light mb-4">Every visit to this ice cream store is a treat! The flavors are unique and the quality is consistently top-notch. Its clear they use the finest ingredients. i am always excited to see what new creations they will come up with next</h4>
                            <img class="img-fluid mx-auto mb-3"  alt="">
                        </div>
                        <div class="text-center">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <h4 class="font-weight-light mb-4">This place isnot just about ice cream; its about the experience. The warm service and the cozy ambiance make it the perfect spot for family outings. Their chocolate fudge sundae is to die for</h4>
                            <img class="img-fluid mx-auto mb-3" alt="">
                        </div>
                    </div>
                </div>
